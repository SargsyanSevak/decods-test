      ...
      >
        ...
        >
          <path
            ...
            fill={scrolled ? "#292929" : "#fff"}
            fillOpacity={scrolled ? "0.9" : "0.83"}
          />
          <path
      ...
      >
        <li>
          ...
          >
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="!bg-transparent px-0 py-0 h-auto !hover:bg-transparent !focus:bg-transparent !active:bg-transparent !text-white">
                  <span className="flex items-center gap-1">Services</span>
                </NavigationMenuTrigger>

                <NavigationMenuContent className="bg-white text-black rounded-md shadow-md p-4">
